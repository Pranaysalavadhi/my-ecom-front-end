...
const Navbar = ({ onSelectCategory, onSearch }) => {
  ...
  const fetchData = async (value) => {
    try {
      const response = await axios.get("https://ecom-backend-proj.onrender.com/api/products");
  ...
  const handleChange = async (value) => {
    ...
    try {
      const response = await axios.get(
        `https://ecom-backend-proj.onrender.com/api/products/search?keyword=${value}`
      );
      setSearchResults(response.data);
      ...
      <header>
        <nav className="navbar navbar-expand-lg fixed-top">
          <div className="container-fluid">
            <a className="navbar-brand" href="https://www.linkedin.com/in/pranaydeep-s">
              Pranay
            </a>
            <button
